    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
        ...
        <div className='lg:col-span-2'>
          <img src={car.image} alt={car.model} className='w-full h-auto md:max-h-100 object-cover rounded-xl mb-6 shadow-md'/>
        ...
        {/* Car Booking Section */}
                  <form onSubmit={handleSubmit} className='shadow h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500 '>
                ...
                <div className='flex flex-col gap-2'>
                  ...
                  <input type="date" id="pickup-date" className='border 
                  border-borderColor rounded-lg px-3 py-2 ' required min={new Date().toISOString().split("T")[0]}/>
                </div>

                <div className='flex flex-col gap-2'>
                  <label htmlFor="return-date" className='block mb-2'>Return Date</label>
                  <input type="date" id="return-date" className='border 
                  border-borderColor rounded-lg px-3 py-2 ' required />
                </div>

                <button className='w-full bg-primary text-white py-3 rounded-xl
                hover:bg-primary-dull font-medium cursor-pointer'>Book Now</button>
