  ...
  return (
    <div className="px-4 pt-10 md:px-10 flex-1">
      <Title
        ...
        subtitle="Monitor overall platform performance including cars, bookings, and revenue"
      />
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-8
      max-w-3xl">
        {dashboardCards.map((card, index) => 
        <div key={index} className="flex items-center gap-2 p-4 jsutify-between
        ...
        <div className="flex flex-wrap items-start gap-6 mb-8 w-full">
            ...
            <div className="p-4 md:p-6 border border-borderColor rounded-md max-w-lg w-full">
                ...
                <p className="text-gray-500">Latest customers and their bookings</p>
